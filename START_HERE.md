...
| 查 Mem、Stars、Room、矛盾书 | `docs/architecture/SYSTEM_ZONES.md` § 住户数据注意事项 | 按对象读 `docs/architecture/MEMORY_ROOM.md` 或 `docs/architecture/REQUEST_CONTEXT.md`；改核心语义再读 `DESIGN.md` |
