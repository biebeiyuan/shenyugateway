...
.batch-result-card { display: grid; grid-template-columns: minmax(0, 1fr) minmax(320px, 430px); align-items: center; gap: 20px; padding: 14px; border: 1px solid #f0e2df; border-radius: 8px; background: #fff; }
