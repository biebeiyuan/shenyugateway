...
import RoomNewspaperPanel from '@/views/room/RoomNewspaperPanel.vue'
...
const noteDraft = ref('')
const newspaperPanel = ref<InstanceType<typeof RoomNewspaperPanel> | null>(null)
