...
`,[$(">",[y("clear",`
 ...
 `,[ue("scrollable",[ue("show-header-or-footer","padding: var(--n-padding);")])]),y("header",`
 ...
 transition: border-color .3s var(--n-bezier);
 `),L("scrollable, show-header-or-footer",[y("content",`
 padding: var(--n-padding);
 `)])]),z("popover-shared",`
...
`,[y("input, textarea",`
 ...
 `),$("&:-webkit-autofill ~",[y("placeholder","display: none;")])]),L("round",[ue("textarea","border-radius: calc(var(--n-height) / 2);")]),y("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),L("textarea",[y("placeholder","overflow: visible;")]),ue("autosize","width: 100%;"),L("autosize",[y("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 height: var(--n-height);
 line-height: var(--n-height);
 `,[$("&[type=password]::-ms-reveal","display: none;"),$("+",[y("placeholder",`
 display: flex;
 align-items: center; 
 `)])]),ue("textarea",[y("placeholder","white-space: nowrap;")]),y("eye",`
 display: flex;
 align-items: center;
 ...
 `)]),L("pair",[y("input-el, placeholder","text-align: center;"),y("separator",`
 display: flex;
 align-items: center;
 transition: color .3s var(--n-bezier);
 color: var(--n-text-color);
 ...
 `)]),$("&:hover",[y("state-border","border: var(--n-border-hover);")]),L("focus","background-color: var(--n-color-focus);",[y("state-border",`
...
`),Al=$([z("card",`
 ...
 `),y("content-scrollbar",[$(">",[z("scrollbar-container",[$(">",[z("card-content",`
 padding-top: var(--n-padding-bottom);
 ...
 margin: 0 var(--n-padding-left);
 padding: var(--n-padding-bottom) 0;
 `)])])])])])]),L("footer-segmented",[$(">",[y("footer",`
 padding-top: var(--n-padding-bottom);
 `)])]),L("footer-soft-segmented",[$(">",[y("footer",`
 padding: var(--n-padding-bottom) 0;
 margin: 0 var(--n-padding-left);
 `)])]),$(">",[z("card-header",`
 box-sizing: border-box;
 ...
 `,[$("&:target","border-color: var(--n-color-target);")]),L("action-segmented",[$(">",[y("action",[$("&:not(:first-child)",`
 ...
 `,[$("&:not(:first-child)",`
 border-top: 1px solid var(--n-border-color);
 `)])])]),L("footer-segmented, footer-soft-segmented",[$(">",[y("footer",`
 transition: border-color 0.3s var(--n-bezier);
 `,[$("&:not(:first-child)",`
 border-top: 1px solid var(--n-border-color);
 `)])])]),L("embedded",`
 ...
 `)]))]),Kn={title:[String,Function],contentClass:String,contentStyle:[Object,String],contentScrollable:Boolean,headerClass:String,headerStyle:[Object,String],headerExtraClass:String,headerExtraStyle:[Object,String],footerClass:String,footerStyle:[Object,String],embedded:Boolean,segmented:{type:[Boolean,Object],default:!1},size:String,bordered:{type:Boolean,default:!0},closable:Boolean,hoverable:Boolean,role:String,onClose:[Function,Array],tag:{type:String,default:"div"},cover:Function,content:[String,Function],footer:Function,action:Function,headerExtra:Function,closeFocusable:Boolean},Dl=Zo(Kn),El=Object.assign(Object.assign({},me.props),Kn),Wl=Z({name:"Card",props:El,slots:Object,setup(e){const t=()=>{const{onClose:b}=e;b&&H(b)},{inlineThemeDisabled:n,mergedClsPrefixRef:r,mergedRtlRef:i,mergedComponentPropsRef:l}=Pt(e),d=me("Card","-card",Al,zl,e,r),a=It("Card",i,r),s=V(()=>{var b,f;return e.size||((f=(b=l==null?void 0:l.value)===null||b===void 0?void 0:b.Card)===null||f===void 0?void 0:f.size)||"medium"}),x=V(()=>{const b=s.value,{self:{color:f,colorModal:v,colorTarget:m,textColor:g,titleTextColor:w,titleFontWeight:c,borderColor:A,actionColor:P,borderRadius:D,lineHeight:R,closeIconColor:N,closeIconColorHover:K,closeIconColorPressed:U,closeColorHover:M,closeColorPressed:_,closeBorderRadius:F,closeIconSize:E,closeSize:X,boxShadow:ee,colorPopover:S,colorEmbedded:O,colorEmbeddedModal:W,colorEmbeddedPopover:G,[Ae("padding",b)]:Y,[Ae("fontSize",b)]:he,[Ae("titleFontSize",b)]:le},common:{cubicBezierEaseInOut:J}}=d.value,{top:Pe,left:ot,bottom:we}=$n(Y);return{"--n-bezier":J,"--n-border-radius":D,"--n-color":f,"--n-color-modal":v,"--n-color-popover":S,"--n-color-embedded":O,"--n-color-embedded-modal":W,"--n-color-embedded-popover":G,"--n-color-target":m,"--n-text-color":g,"--n-line-height":R,"--n-action-color":P,"--n-title-text-color":w,"--n-title-font-weight":c,"--n-close-icon-color":N,"--n-close-icon-color-hover":K,"--n-close-icon-color-pressed":U,"--n-close-color-hover":M,"--n-close-color-pressed":_,"--n-border-color":A,"--n-box-shadow":ee,"--n-padding-top":Pe,"--n-padding-bottom":we,"--n-padding-left":ot,"--n-font-size":he,"--n-title-font-size":le,"--n-close-size":X,"--n-close-icon-size":E,"--n-close-border-radius":F}}),h=n?Bt("card",V(()=>s.value[0]),x,e):void 0;return{rtlEnabled:a,mergedClsPrefix:r,mergedTheme:d,handleCloseClick:t,cssVars:n?void 0:x,themeClass:h==null?void 0:h.themeClass,onRender:h==null?void 0:h.onRender}},render(){const{segmented:e,bordered:t,hoverable:n,mergedClsPrefix:r,rtlEnabled:i,onRender:l,embedded:d,tag:a,$slots:s}=this;return l==null||l(),p(a,{class:[`${r}-card`,this.themeClass,d&&`${r}-card--embedded`,{[`${r}-card--rtl`]:i,[`${r}-card--content-scrollable`]:this.contentScrollable,[`${r}-card--content${typeof e!="boolean"&&e.content==="soft"?"-soft":""}-segmented`]:e===!0||e!==!1&&e.content,[`${r}-card--footer${typeof e!="boolean"&&e.footer==="soft"?"-soft":""}-segmented`]:e===!0||e!==!1&&e.footer,[`${r}-card--action-segmented`]:e===!0||e!==!1&&e.action,[`${r}-card--bordered`]:t,[`${r}-card--hoverable`]:n}],style:this.cssVars,role:this.role},Q(s.cover,x=>{const h=this.cover?ye([this.cover()]):x;return h&&p("div",{class:`${r}-card-cover`,role:"none"},h)}),Q(s.header,x=>{const{title:h}=this,b=h?ye(typeof h=="function"?[h()]:[h]):x;return b||this.closable?p("div",{class:[`${r}-card-header`,this.headerClass],style:this.headerStyle,role:"heading"},p("div",{class:`${r}-card-header__main`,role:"heading"},b),Q(s["header-extra"],f=>{const v=this.headerExtra?ye([this.headerExtra()]):f;return v&&p("div",{class:[`${r}-card-header__extra`,this.headerExtraClass],style:this.headerExtraStyle},v)}),this.closable&&p(Yo,{clsPrefix:r,class:`${r}-card-header__close`,onClick:this.handleCloseClick,focusable:this.closeFocusable,absolute:!0})):null}),Q(s.default,x=>{const{content:h}=this,b=h?ye(typeof h=="function"?[h()]:[h]):x;return b?this.contentScrollable?p(Sn,{class:`${r}-card__content-scrollbar`,contentClass:[`${r}-card-content`,this.contentClass],contentStyle:this.contentStyle},b):p("div",{class:[`${r}-card-content`,this.contentClass],style:this.contentStyle,role:"none"},b):null}),Q(s.footer,x=>{const h=this.footer?ye([this.footer()]):x;return h&&p("div",{class:[`${r}-card__footer`,this.footerClass],style:this.footerStyle,role:"none"},h)}),Q(s.action,x=>{const h=this.action?ye([this.action()]):x;return h&&p("div",{class:`${r}-card__action`,role:"none"},h)}))}});export{Ol as A,ti as B,Pl as C,li as D,pl as E,Ai as F,ui as G,$i as H,Me as I,bl as J,gi as L,Wl as N,ci as V,Ll as a,je as b,vi as c,An as d,ft as e,Je as f,Ri as g,Tl as h,ri as i,ni as j,zl as k,Kn as l,Fl as m,Yt as n,ii as o,Dl as p,Bl as q,Mn as r,En as s,_n as t,ai as u,Il as v,il as w,kl as x,fl as y,Bn as z};
