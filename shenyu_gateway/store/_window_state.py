        ...
        with self._connect() as conn:
            conn.execute(
                ...
                INSERT INTO context_window_states (
                    ...
                    island_state_json, last_event_class, reset_reason, created_at, updated_at
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                ...
                (
                    ...
                    payload["last_event_class"], payload["reset_reason"], now_text, now_text,
                ),
            )
        return {**state, **payload, "island_state": state.get("island_state") or {}}
