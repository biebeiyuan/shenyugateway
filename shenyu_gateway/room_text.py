...
ROOM_FORMAT_HINT = "窗开着。东西都在。"


# ── 上次痕迹 ──────────────────────────────────────────────────────────

TRACE_PHRASES: dict[str, str] = {
    "window":         "上次来的时候，只是在窗边看了一眼外面的海。",
    "sit":            "上次来的时候，在窗边坐了一会儿。",
...
DOORS = [
    ...
    _door(
        ...
        zone="shelf",
        base=(
            "书桌旁边有一排矮书架：自动生成的《家现在》、会继续长大的《我是谁》，"
            "还有过去原文的来历书。书名和近况已经露在房间里。\n"
            "想翻开、续写《我是谁》或追加批注，用 `shenyu_books`。"
        ),
    ),
