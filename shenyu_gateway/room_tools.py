...
from .newspaper_basket import (
    NEWSPAPER_BASKET_DESCRIPTION,
    NEWSPAPER_BASKET_PARAMETERS,
    newspaper_basket_trace_detail,
    newspaper_payload,
    read_newspaper_basket,
)
    ...
    tools = [
        ...
        },
        {
            ...
            "function": {
                ...
                # 说明书和日常那扇门共用一份，见 newspaper_basket.py。
    ...
    *,
    ...
    if name == "room_drawer_notes":
        ...
        if issue:
            ...
            result["newspaper"] = newspaper_payload(delivered)
        return result
