...
- `scripts/doc_touchpoints.py`: run it before handing off to see which documents historically changed with the files you touched (`--staged` for staged changes only, bare paths to ask about specific files). Advice only, always exits 0.
